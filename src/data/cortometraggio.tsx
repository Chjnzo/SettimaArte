...
export const edizioniData: EdizioneCorto[] = [
  {
    ...
    descrizione: (
      <>
        <p>La prima edizione di questo percorso ha dato vita al cortometraggio <em>Le Faremo Sapere</em>, diretto da Beppe Tufarulo e interpretato da Giorgio Marchesi e Antonia Fotaras.</p>
        <p>Il progetto ha ottenuto importanti riconoscimenti nel circuito festivaliero, tra cui due premi al Cortinametraggio, i premi per Miglior Sceneggiatura e Miglior Attore Protagonista al E Fu Cinema Festival di Pomarance, il Premio Troisi Videocorto Nettuno e due riconoscimenti come Miglior Attore e Miglior Attrice al Movievalley Festival Bologna.</p>
        <p>Il cortometraggio è inoltre entrato nella shortlist dei David di Donatello e successivamente selezionato tra i finalisti dei Nastri d'Argento.</p>
      </>
    ),
    trama:
  ...
  },
  {
    ...
    descrizione: (
      <>
        <p>La seconda edizione ha portato alla realizzazione di <em>Sono sempre qui per te</em>, diretto da Marco Pacchiana e interpretato da Jacopo Olmo Antinori, Walter Tiraboschi e Giulia Gonella.</p>
        <p>Il cortometraggio è attualmente in distribuzione nei principali festival nazionali e sarà disponibile alla visione al termine del suo percorso nel circuito festivaliero.</p>
      </>
    ),
    trama:
